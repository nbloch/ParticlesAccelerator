function [ V, Z, X, Vz, Vx, Vy, MSE, fig, zGrid, rGrid, Rq, Zq, Rb, Zb, Ez, Er,...
    Mbleft, Mbright, NLeft, focused_particles, entryEmittance, exitEmittance, Q, numericErr] =...
...
if (simulateMultiParticles)
    tic;
    [ Z, X, Vz, Vx, Vy, fig.PhaseSpace, fig.numErrFig, fig.EmittanceVsZ, trajParams, trajectoryLen,...
                focused_particles, entryEmittance, exitEmittance, numericErr] = ...
